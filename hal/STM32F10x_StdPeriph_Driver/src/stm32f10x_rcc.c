...
/**
  ...
  * @param RCC AHBPeriph：指定 AHB 外设对其时钟进行门控
  *  
  * 对于 @b STM32 Connectivity 系列设备，此参数可以是任意组合
  * 的值：       
  * @arg RCC AHBPeriph DMA1
  * @arg RCC AHBPeriph DMA2
  * @arg RCC AHBPeriph SRAM
  * @arg RCC AHBPeriph FLITF
  * @arg RCC AHBPeriph CRC
  * @arg RCC AHBPeriph OTG FS   
  * @arg RCC AHBPeriph ETH MAC  
  * @arg RCC AHBPeriph ETH MAC Tx
  * @arg RCC AHBPeriph ETH MAC Rx
  *
  * 对于@b其他 STM32 设备，此参数可以是
  * 以下值：       
  * @arg RCC AHBPeriph DMA1
  * @arg RCC AHBPeriph DMA2
  * @arg RCC AHBPeriph SRAM
  * @arg RCC AHBPeriph FLITF
  * @arg RCC AHBPeriph CR
  * @arg RCC AHBPeriph FSMC
  * @arg RCC AHBPeriph SDIO
  *  
 ...
 * @brief 启用或禁用高速 APB （APB2） 外设时钟
  * @param RCC APB2Periph：指定 APB2 外设对其时钟进行门控
  * 此参数可以是以下值的任意组合：
  * @arg RCC APB2Periph AFIO， RCC APB2Periph GPIOA， RCC APB2Periph GPIOB，
  * RCC APB2Periph GPIOC， RCC APB2Periph GPIOD， RCC APB2Periph GPIOE，
  * RCC APB2Periph GPIOF， RCC APB2Periph GPIOG， RCC APB2Periph ADC1，
  * RCC APB2Periph ADC2， RCC APB2Periph TIM1， RCC APB2Periph SPI1，
  * RCC APB2Periph TIM8， RCC APB2Periph USART1， RCC APB2Periph ADC3，
  * RCC APB2Periph TIM15， RCC APB2Periph TIM16， RCC APB2Periph TIM17，
  * RCC APB2Periph TIM9， RCC APB2Periph TIM10， RCC APB2Periph TIM11    
  * @param NewState：指定外设时钟的新状态
  * 此参数可以是：ENABLE 或 DISABLE
  * @retval 无
  */
...
/**
  ...
  * @param RCC APB1Periph：指定 APB1 外设对其时钟进行门控
  * 此参数可以是以下值的任意组合：
  * @arg RCC APB1Periph TIM2， RCC APB1Periph TIM3， RCC APB1Periph TIM4，
  * RCC APB1Periph TIM5， RCC APB1Periph TIM6， RCC APB1Periph TIM7，
  * RCC APB1Periph WWDG， RCC APB1Periph SPI2， RCC APB1Periph SPI3，
  * RCC APB1Periph USART2， RCC APB1Periph USART3， RCC APB1Periph USART4，
  * RCC APB1Periph USART5， RCC APB1Periph I2C1， RCC APB1Periph I2C2，
  * RCC APB1Periph USB， RCC APB1Periph CAN1， RCC APB1Periph BKP，
  * RCC APB1Periph PWR， RCC APB1Periph DAC， RCC APB1Periph CEC，
  * RCC APB1Periph TIM12， RCC APB1Periph TIM13， RCC APB1Periph TIM14
  * @param NewState：指定外设时钟的新状态
  * 此参数可以是：ENABLE 或 DISABLE
  * @retval 无
  */
